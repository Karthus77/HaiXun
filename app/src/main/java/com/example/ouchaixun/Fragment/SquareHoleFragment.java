...
public class SquareHoleFragment extends Fragment {
    ...
    public void GetSquare(final List<Map<String,Object>> list, final Boolean refresh){
        ...
        if (page<=o_page) {
            ...
            OKhttpUtils.get_token(token ,
                    "http://47.102.215.61:8888/passage/passage_list?page="+page+"&tag=2", new OKhttpUtils.OkhttpCallBack() {
                        @Override
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        smartRefreshLayout=view.findViewById(R.id.hole_refresh);
        relativeLayout=view.findViewById(R.id.hole_background);
        recyclerView=view.findViewById(R.id.hole_recycler);
